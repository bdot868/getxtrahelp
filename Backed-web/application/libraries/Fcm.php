...
class Fcm {
    ...
    public function sendMessage_____($payload, $notification, $device) {
        ...
        return $this->sendPushNotification(['to' => $device, 'data' => $data]);
    }
    ...
    public function sendMessage($payload, $notification, $device) {
        ...
        return $this->sendPushNotification(['registration_ids' => $device,'notification'=> $notification,'data' => $data]);
    }

    public function sendMessageNew($payload, $notification, $device) {
        $notification["vibrate"] = 1;
        $notification["sound"] = 1;
        $notification["largeIcon"] = 'large_icon';
        $notification["smallIcon"] = 'small_icon';
