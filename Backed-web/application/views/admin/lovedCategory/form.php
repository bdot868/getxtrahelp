                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" id="form" action="<?php echo $page['url'] ?>/set" >
                            ...
                            <input type="hidden" name="lovedcat_name" id="lovedcat_name" value="<?php echo isset($data->name) ? $data->name : "" ?>">
    ...
    $("#form").validate({
        rules: {
            name: {
                ...
                remote: {
                    url: "<?php echo $page['url'] ?>/checkLovedCategory",
                    type: "post",
                    data: {
                        ...
                        lovedcat_name: function() {
                            return $('#lovedcat_name').val();
                        }
                    },
                }
            },
        ...
        messages: {
            name: {
                ...
                remote: "Loved Category already exist"
            },
        },
    });
</script>