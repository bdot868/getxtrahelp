                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" id="form" action="<?php echo $page['url'] ?>/set" >
                            ...
                            <input type="hidden" name="lovedspe_name" id="lovedspe_name" value="<?php echo isset($data->name) ? $data->name : "" ?>">
    ...
    $("#form").validate({
        rules: {
            name: {
                ...
                remote: {
                    url: "<?php echo $page['url'] ?>/checkLovedSpecialities",
                    type: "post",
                    data: {
                        ...
                        lovedspe_name: function() {
                            return $('#lovedspe_name').val();
                        }
                    },
                }
            },
        ...
        messages: {
            name: {
                ...
                remote: "Loved Specialities already exist"
            },
        },
    });
</script>