                        ...
                        <form method="post" id="form" action="<?php echo $page['url'] ?>/set">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type">
                                    ...
                                    <option value="1" <?php echo isset($data->type) && $data->type == "1" ? "selected" : "" ?>>User</option>
                                    <option value="2" <?php echo isset($data->type) && $data->type == "2" ? "selected" : "" ?>>Caregiver</option>
                                    <option value="3" <?php echo isset($data->type) && $data->type == "3" ? "selected" : "" ?>>Both</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Name</label>
