            ...
            <div class="card-body">
                ...
                <table class="table table-striped" cellspacing="0" width="100%">
                    <tbody>
                        ...
                        <tr>
                            <td width="20%">How soon you planning to hire</td>
                            <td><?= (isset($data->soonPlanningHireDate) && $data->soonPlanningHireDate != '0000-00-00')?date('d M Y',strtotime($data->soonPlanningHireDate)):"" ?></td>
                        </tr>
                        <tr>
