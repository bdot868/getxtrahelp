                ...
                <div class="row">
                    <div class="col-md-6">
                        <form method="post" id="form" enctype="multipart/form-data" action="<?php echo $page['url'] ?>/personalInformation">
                            ...
                            <div class="form-group">
                                <label>How soon you planning to hire</label>
                                <input type="text" class="form-control" id="soonPlanningHireDate" name="soonPlanningHireDate" value="<?php echo (isset($data->soonPlanningHireDate) && $data->soonPlanningHireDate != '0000-00-00') ? $data->soonPlanningHireDate : "" ?>">
                            </div>
                            <div class="form-group">
