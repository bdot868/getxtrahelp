...
class Work_Method_Of_Transportation_Model extends CI_Model {

    public function __construct() {
        parent::__construct(); 
        $this->table = "tbl_work_method_of_transportation";
    }
    ...
    public function get($data = [], $single = false, $num_rows = false) {
        ...
        if ($num_rows) {
            ...
            if(isset($data['apiResponse'])){
                $this->db->select($this->table . '.id as workMethodOfTransportationId');
