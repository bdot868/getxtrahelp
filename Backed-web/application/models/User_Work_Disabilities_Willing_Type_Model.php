...
class User_Work_Disabilities_Willing_Type_Model extends CI_Model {

    public function __construct() {
        parent::__construct(); 
        $this->table = "tbl_user_work_disabilities_willing_type";
    ...
    public function get($data = [], $single = false, $num_rows = false) {
        ...
        if ($num_rows) {
            ...
            if(isset($data['apiResponse'])){
                $this->db->select($this->table . '.id as userWorkJobDisabilitiesWillingTypeId');
        ...
        if (isset($data['getWorkJobDisabilitiesWillingTypeData']) && $data['getWorkJobDisabilitiesWillingTypeData'] == true) {
            $this->db->select($this->tbl_work_disabilities_willing_type . '.name');
