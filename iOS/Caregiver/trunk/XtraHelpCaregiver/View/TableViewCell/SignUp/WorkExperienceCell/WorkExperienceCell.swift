...
class WorkExperienceCell: UITableViewCell {
    ...
    func setWorkExperienceData(obj : WorkExperienceModel){
        ...
        self.lblEndDate?.text = obj.endDate.isEmpty ? "Present" : obj.endDate //.getDateFromString(format: AppConstant.DateFormat.k_yyyy_MM_dd).getTimeString(inFormate: AppConstant.DateFormat.k_MM_dd_yyyy)
