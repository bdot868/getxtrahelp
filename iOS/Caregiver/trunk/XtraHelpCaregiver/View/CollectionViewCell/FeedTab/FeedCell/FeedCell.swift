...
extension FeedCell : UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        /*if indexPath.row == 0 {
            cell.imgFeed?.image = #imageLiteral(resourceName: "imgDemoFeed")
        } else if indexPath.row == 1 {
            cell.imgFeed?.image = #imageLiteral(resourceName: "ImgDemoFeed2")
...
/*extension FeedCell : FSPagerViewDataSource,FSPagerViewDelegate {
    ...
    func pagerView(_ pagerView: FSPagerView, cellForItemAt index: Int) -> FSPagerViewCell {
        if let cell = pagerView.dequeueReusableCell(withReuseIdentifier: CellIdentifier.kFeedImageCell, at: index) as? FeedImageCell {
            if index == 0 {
                cell.imgFeed?.image = #imageLiteral(resourceName: "imgDemoFeed")
            } else if index == 1 {
                cell.imgFeed?.image = #imageLiteral(resourceName: "ImgDemoFeed2")
