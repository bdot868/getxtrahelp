...
-(void)setup {
    ...
    [[UISlider appearance] setThumbTintColor:[UIColor clearColor]];
...
-(void)layoutSubviews {
    ...
    if(!thumbLabel){
        thumbLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 35, 35)];
        thumbLabel.layer.cornerRadius = 10;
        thumbLabel.layer.borderWidth = 2.0;
        thumbLabel.layer.borderColor = [UIColor colorWithRed:247.0/225.0 green:156.0/225.0 blue:28.0/225.0 alpha:1.0/1.0].CGColor;//[UIColor orangeColor].CGColor;
