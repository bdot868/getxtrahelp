...
enum TutorialImages : Int {
    ...
    var HeaderName : String {
        switch self {
        case .tutorial1:
            return "Your Xtra Help can change somebody’s world."
        case .tutorial2:
            return "Apply for jobs that suit you best!"
        case .tutorial3 :
            return "Earn a little Xtra in the care industry "
        }
    }
    ...
    var HeaderDescName : String {
        ...
        {
        case .tutorial1:
            return "If you are qualified to be a caregiver, be a part of a family that might need your special care."
        case .tutorial2:
            return "Read through the job description and apply according to your preferences."
        case .tutorial3 :
            return "If you have some Xtra hours in your schedule, join Xtra Help to earn some extra money."
        }
    }
...
enum TabbarItemType : Int {
    ...
    var img : UIImage {
        switch self {
        case .Home:
            return #imageLiteral(resourceName: "ic_TabHomeUnSelected")
        case .MyJobs:
            return #imageLiteral(resourceName: "ic_TabMyJobUnSelected")
        case .MyCalender :
            return  #imageLiteral(resourceName: "ic_TabCalenderUnSelected")
        case .Feed :
            return #imageLiteral(resourceName: "ic_TabFeedUnSelected")
        }
    }
//    #imageLiteral(resourceName:sidemenu)
    var Selectimg : UIImage {
        ...
        case .MyCalender :
          return  UIImage(imageLiteralResourceName: "select_Tab_Calender")
        case .Feed :
...
enum ProfileStatusEnum : String {
    ...
    case CertificationsLicenses = "3"
    case YourAddress = "4"
    case WorkDetails = "5"
    case Insurance = "6"
    case SetAvailabilityAndUnderReview = "7"
    case ReviewAndAccepted = "8"
...
struct Masking {
    ...
    static let kRoutingNumberMasking = "XXXXXXXXX"
}
...
class AppConstant {
    ...
    struct API {
        ...
        static let StripeRedirectURI = "https://app.getxtrahelp.com/"
        //static let StripeRedirectURI = "http://project.greatwisher.com/"
        
        //static let MAIN_URL = "http://project.greatwisher.com/app-xtrahelp/"
        static let MAIN_URL = "https://app.getxtrahelp.com/"
        ...
        static let kgetWorkDetails = BASE_URL + "users/getWorkDetails"
        ...
        static let ksaveDoctorRating        = BASE_URL + "patient/saveDoctorRating"
        ...
        static let kgetAccountChartData = BASE_URL + "payment/getAccountChartData"
        ...
        static let kgetUserJobList          = BASE_URL + "caregiver/getUserJobList"
        static let kgetUserJobDetail          = BASE_URL + "caregiver/getUserJobDetail"
        static let kapplyUserJob          = BASE_URL + "caregiver/applyUserJob"
        static let kgetCaregiverRelatedJobList          = BASE_URL + "caregiver/getCaregiverRelatedJobList"
        static let kmodifyJobAnswer          = BASE_URL + "caregiver/modifyJobAnswer"
        static let kcancelUpcomingJob          = BASE_URL + "caregiver/cancelUpcomingJob"
        static let kcancelJobRequest          = BASE_URL + "caregiver/cancelJobRequest"
        static let kcaregiverSubstituteJob          = BASE_URL + "caregiver/caregiverSubstituteJob"
        static let ksendSubstituteJobRequest          = BASE_URL + "caregiver/sendSubstituteJobRequest"
        static let kgetSubstituteJobRequestList          = BASE_URL + "caregiver/getSubstituteJobRequestList"
        static let kgetAwardJobRequestList          = BASE_URL + "caregiver/getAwardJobRequestList"
        
        static let kacceptSubstituteJobRequest          = BASE_URL + "caregiver/acceptSubstituteJobRequest"
        static let krejectSubstituteJobRequest          = BASE_URL + "caregiver/rejectSubstituteJobRequest"
        
        static let kacceptAwardJobRequest          = BASE_URL + "caregiver/acceptAwardJobRequest"
        static let kdeclineAwardJobRequest          = BASE_URL + "caregiver/declineAwardJobRequest"
        
        static let kgetCaregiverDashboard          = BASE_URL + "caregiver/getCaregiverDashboard"
        static let kgetCaregiverList          = BASE_URL + "caregiver/getCaregiverList"
        static let kgetCaregiverRelatedJobDetail = BASE_URL + "caregiver/getCaregiverRelatedJobDetail"
        static let kverifyJobVerificationCode = BASE_URL + "caregiver/verifyJobVerificationCode"
        static let kgetCaregiverMyProfile = BASE_URL + "caregiver/getCaregiverMyProfile"
        static let kgetCaregiverAvailabilitySetting = BASE_URL + "users/getCaregiverAvailabilitySetting"
        static let ksaveCaregiverAvailability = BASE_URL + "users/saveCaregiverAvailability"
        static let kgetCaregiverAvailabilitySettingNew = BASE_URL + "users/getCaregiverCalendarAvailabilityNew"//getCaregiverAvailabilitySettingNew"
        static let kremoveSingleAvailabilityNew = BASE_URL + "users/removeSingleAvailabilityNew"
        ...
        static let kendUserJob          = BASE_URL + "caregiver/endUserJob"
        
        static let kuploadJobMedia          = BASE_URL + "caregiver/uploadJobMedia"
        
        static let kgetRequestAddJobHoursDetail          = BASE_URL + "caregiver/getRequestAddJobHoursDetail"
        
        static let kacceptAddJobHoursRequest          = BASE_URL + "caregiver/acceptAddJobHoursRequest"
        static let kdeclineAddJobHoursRequest          = BASE_URL + "caregiver/declineAddJobHoursRequest"
        ...
        //Bank
        static let ksaveBankDetailInStripe = BASE_URL + "payment/saveBankDetailInStripe"
        static let kgetBankDetail = BASE_URL + "payment/getBankDetail"
        
        //Stripe
        static let kconnectStripe = BASE_URL + "payment/connectStripe"
        static let kwithdrawHistory = BASE_URL + "payment/withdrawHistory"
        static let kwithdraw = BASE_URL + "payment/withdrawMoney"
        static let kgetWalletData = BASE_URL + "payment/getWalletAmount"
    ...
    struct ValidationMessages {
        ...
        static let kEmptyLicenceType = "Please select license type"
        static let kEmptyLicenceName = "Please enter license holder name"
        static let kEmptyLicenceNumber = "Please enter license number"
        static let kEmptyLicenceDateIssued = "Please enter license date issued"
        static let kEmptyLicenceDateExpires = "Please enter license date expires"
        static let kEmptyLicenceImage = "Please upload license image"
        
        static let kEmptyInsuranceType = "Please select insurance type"
        static let kEmptyInsuranceName = "Please enter insurance holder name"
        static let kEmptyInsuranceNumber = "Please enter insurance number"
        static let kEmptyInsuranceDateIssued = "Please enter insurance date issued"
        static let kEmptyInsuranceDateExpires = "Please enter insurance date expires"
        static let kEmptyInsuranceImage = "Please upload insurance image"
        ...
        static let kEmptyTypesofdisabilitiescaregiveriswillingtowork  = "Please select types of disabilities caregiver is willing to work with"
        static let kEmptyYearsofexperience = "Please select years of experience"
        static let kEmptyAdditionalQuestionAnswer = "Please enter answers of Questions"
        /*static let k = ""
        static let k = ""*/
        
        //Bank
        static let kEmptyBankHolderName = "Please enter account holder name"
        static let kEmptyBankRoutingNumber = "Please enter routing number"
        static let kEmptyBankAccoutnNumber = "Please enter account number"
        static let kValidBankAccoutnNumber = "Account number should be 9 to 18 digits"
        static let kEmptyBankMatchAccountNumber = "Account number and confirm account number do not match"
        static let kEmptyConfirmAccoutnNumber = "Please confirm your account number"
        static let kValidBankRoutingNumber = "Routing number should be 9 digits"
        
        static let kEmptyAmount = "Please enter withdraw amount"
        static let kValidWithdrawAmount = "Please enter valid withdraw amount"
        static let kExceedWithdrawAmount = "Your withdrawal amount exceeds the total amount"
    }
    ...
    struct AlertMessages {
        ...
        static let kApplyJob               = "Are you sure you want to apply for the job?"
...
struct APIKeys {
    ...
    static let GooglePlaceAPIKey = "AIzaSyBVhRAiqbiO54B9LS47TOLANfFz4tU4oC0"//AIzaSyAOXcITbfxO2EV_HSJ_gImF1Lp3KFE17lM
...
struct AlertTitles {
    ...
    static let kDeleteSearchHistory = "Are you sure want to clear all recent search history?"
}
...
extension UIColor {
    struct CustomColor {
        ...
        //F3F4F7
        static let CalendarTabBGColor = #colorLiteral(red: 0.9529411765, green: 0.9568627451, blue: 0.968627451, alpha: 1)
        
        //262654
        static let CalendarTabSelectColor = #colorLiteral(red: 0.1490196078, green: 0.1490196078, blue: 0.3294117647, alpha: 1)
        ...
        //E41E27
        static let EndVideoColor = #colorLiteral(red: 0.8941176471, green: 0.1176470588, blue: 0.1529411765, alpha: 1)
        ...
        //242529
        static let SearchDefaulrColor = #colorLiteral(red: 0.1411764706, green: 0.1450980392, blue: 0.1607843137, alpha: 0.38)
        ...
        //363E4B
        static let cardHeaderColor = #colorLiteral(red: 0.2117647059, green: 0.2431372549, blue: 0.2941176471, alpha: 1)
...
struct NotificationPostname {
    ...
    static let kUpdateWorkHoursCount = "UpdateWorkHoursCount"
}
