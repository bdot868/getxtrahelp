...
extension AppSideMenuViewController {
    ...
    func prepareSections() {
       // self.configureProfileData()
        ...
        self.sections = [.MYPROFILE,.Accounts,.PaymentsBilling,.MyReview,.NOTIFICATIONS,.Support]//[.MYPROFILE,.SUBSCRIPTION,.Accounts,.PaymentsBilling,.MyReview,.NOTIFICATIONS,.Support]
