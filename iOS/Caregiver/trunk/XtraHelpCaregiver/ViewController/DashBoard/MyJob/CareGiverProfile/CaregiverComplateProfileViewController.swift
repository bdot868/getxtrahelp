//
//  CaregiverComplateProfileViewController.swift
//  XtraHelpCaregiver
//
...
class CaregiverComplateProfileViewController: UIViewController {
    ...
    @IBAction func btnSeeAllReviewsClicked(_ sender: XtraHelpButton) {
        if let obj = self.userProfileData {
            self.appnav?.push(CaregiverSeeAllReviewListViewControllerViewController.self,configuration: { vc in
...
// MARK: - Init Configure
extension CaregiverComplateProfileViewController {
    ...
    private func InitConfig(){
        ...
        self.btnNav?.setTitleColor(UIColor.CustomColor.tabBarColor, for: .normal)
        self.btnNav?.titleLabel?.font = UIFont.RubikMedium(ofSize: GetAppFontSize(size: 18.0))
    ...
    private func configureNavigationBar(){
        if self.isfromSubstitude {
            ...
            appNavigationController?.appNavigationControllersetTitleWithBack(title: "Complete Profile", TitleColor: UIColor.CustomColor.tabBarColor, navigationItem: self.navigationItem)
...
extension CaregiverComplateProfileViewController : UITableViewDataSource, UITableViewDelegate {
...
extension CaregiverComplateProfileViewController : UICollectionViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension CaregiverComplateProfileViewController: ViewControllerDescribable{
...
extension CaregiverComplateProfileViewController: AppNavigationControllerInteractable { }
