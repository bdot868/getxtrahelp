...
class TransactionCell: UITableViewCell {
    ...
    var isFromAcocunt : Bool = false {
        didSet{
            self.imgAccount?.image = isFromAcocunt ? #imageLiteral(resourceName: "ic_CalenderAccount") : #imageLiteral(resourceName: "ic_DollarTick")
        }
    }
    ...
    func setTransactionData(obj : TransactionModel){
        ...
        //self.imgAccount?.tintColor = UIColor.CustomColor.tabBarColor
    }
}
