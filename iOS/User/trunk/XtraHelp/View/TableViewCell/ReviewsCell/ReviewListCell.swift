//
//  MentorReviewListCell.swift
//  Momentor
//
//  Created by wm-devIOShp on 14/10/21.
//
...
class ReviewListCell: UITableViewCell {
    ...
    private func InitConfig(){
        ...
        self.lblReviewDesc?.font = UIFont.RubikRegular(ofSize: GetAppFontSize(size: 14.0))
        
        self.lblReviewTime?.textColor = UIColor.CustomColor.textConnectLogin
        self.lblReviewTime?.font = UIFont.RubikRegular(ofSize: GetAppFontSize(size: 12.0))
...
// MARK: - NibReusable
extension ReviewListCell: NibReusable{}
