...
class DocumentPicker: NSObject,UIDocumentPickerDelegate,UINavigationControllerDelegate {
    ...
    public func openDocumentPicker(pickerHandler:@escaping(URL)->()){
        ...
        let importMenu = UIDocumentPickerViewController(documentTypes: [String(kUTTypePDF as String),String(kUTTypeText as String),String(kUTTypeRTF as String),String(kUTTypePlainText as String),String(kUTTypeRTFD as String)], in: .import)
