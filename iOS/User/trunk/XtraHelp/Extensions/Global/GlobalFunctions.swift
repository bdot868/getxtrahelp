...
extension UserDefaults {
    ...
    class var isShowCreateJobTutorial: Bool {
        get {
            return UserDefaults.standard.bool(forKey: UserDefaultsKey.kIsShowTutorial)
        }
        set {
            UserDefaults.standard.set(newValue, forKey: UserDefaultsKey.kIsShowTutorial)
        }
    }
...
extension UILabel{
    func resolveHashTags(){
        ...
        if let nsText = self.text as NSString? {
            ...
            let attrs = [
                NSAttributedString.Key.font : UIFont.RubikRegular(ofSize: GetAppFontSize(size: 14.0)),
