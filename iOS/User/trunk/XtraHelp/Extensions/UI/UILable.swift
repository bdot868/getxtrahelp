...
extension UILabel {
    ...
    func setFindJobHeaderAttributedTextLable(firstText : String,SecondText :String) {
        ...
        let accountAttributes = [NSAttributedString.Key.foregroundColor: UIColor.CustomColor.tabBarColor, NSAttributedString.Key.font: UIFont.RubikRegular(ofSize: GetAppFontSize(size: 25.0))]
        let signupAttributes = [NSAttributedString.Key.foregroundColor: UIColor.CustomColor.tabBarColor, NSAttributedString.Key.font: UIFont.RubikSemiBold(ofSize: GetAppFontSize(size: 25.0))]
    ...
    func setApplicationCountHeaderAttributedTextLable(firstText : String,SecondText :String) {

        let accountAttributes = [NSAttributedString.Key.foregroundColor: UIColor.CustomColor.HomeCategoryColor, NSAttributedString.Key.font: UIFont.RubikRegular(ofSize: GetAppFontSize(size: 11.0))]
        let signupAttributes = [NSAttributedString.Key.foregroundColor: UIColor.CustomColor.tabBarColor, NSAttributedString.Key.font: UIFont.RubikSemiBold(ofSize: GetAppFontSize(size: 18.0))]

        let account = NSMutableAttributedString(string: firstText, attributes: signupAttributes)
        let signup = NSMutableAttributedString(string: SecondText, attributes: accountAttributes)
