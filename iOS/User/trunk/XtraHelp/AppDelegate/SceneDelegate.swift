...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, openURLContexts URLContexts: Set<UIOpenURLContext>) {
        ...
        print(url)
        /*if url.absoluteString.contains("//referral") {
            print("Referal Link")
            if let user = UserModel.getCurrentUserFromDefault()  {
                ...
                let data : [String:Any] = [kreferralCode : id]
                NotificationCenter.default.post(name: Notification.Name(NotificationPostname.kOpenRegistration), object: nil,userInfo: data)
            }
            ...
            if let user = UserModel.getCurrentUserFromDefault()  {
                ...
                print(url.lastPathComponent)
                let id : String = "\(url.lastPathComponent)"
                let data : [String:Any] = [kBlogID : id]
                NotificationCenter.default.post(name: Notification.Name(NotificationPostname.kOpenBlogDetail), object: nil,userInfo: data)
