...
import com.app.xtrahelpcaregiver.Request.SocialLoginRequest
...
import com.app.xtrahelpcaregiver.linkedInManager.LinkedInRequestManager
...
import com.app.xtrahelpcaregiver.linkedInManager.events.LinkedInManagerResponse
...
import kotlinx.android.synthetic.main.activity_signup.facebookImg
import kotlinx.android.synthetic.main.activity_signup.googleImg
import kotlinx.android.synthetic.main.activity_signup.linkedInImg
import kotlinx.android.synthetic.main.activity_signup.passwordImg
import kotlinx.android.synthetic.main.activity_signup.relative
import kotlinx.android.synthetic.main.activity_signup.twitterImg
...
class SignupActivity : BaseActivity(), LinkedInManagerResponse {
    var totalCount = 0
    ...
    private fun init() {
        ...
        etName.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence, p1: Int, p2: Int, p3: Int) {
                totalCount = p0.split("\\s+".toRegex()).size
            }
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.txtTermsCondition -> startActivity(
...
//        utils.dismissProgress()
    ...
    private fun isValid(): Boolean {
        ...
        if (etName.text.toString().isEmpty()) {
            ...
            message = getString(R.string.enterFullName)
            etName.requestFocus()
        ...
        }  else if (!etPassword.text!!.matches(".*[A-Z].*".toRegex())|| !etPassword.text!!.matches(".*[a-z].*".toRegex()) || !etPassword.text!!.matches(".*[!@#$%^&*+=/?].*".toRegex())) {
