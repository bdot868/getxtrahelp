...
import kotlinx.android.synthetic.main.activity_otp.arrowBack
import kotlinx.android.synthetic.main.activity_otp.relative
                    ...
                    if (response.isSuccessful) {
                        ...
                        when (loginResponse.status) {
                            "1" -> {
                                ...
                                pref.setString(Const.isStripeConnect, loginResponse.data.isStripeConnect)
                                pref.setString(
                                    Const.profileStatus,
