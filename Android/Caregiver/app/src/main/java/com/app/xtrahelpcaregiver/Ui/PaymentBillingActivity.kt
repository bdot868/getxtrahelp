...
import com.app.xtrahelpcaregiver.Adapter.CardAdapter
import com.app.xtrahelpcaregiver.Adapter.TransactionAdapter
import com.app.xtrahelpcaregiver.CustomView.CardType
import com.app.xtrahelpcaregiver.CustomView.CreditCardFormattingTextWatcher
import com.app.xtrahelpcaregiver.Interface.CardDeleteClickListner
import com.app.xtrahelpcaregiver.Interface.CardTypeDetect
import com.app.xtrahelpcaregiver.R
import com.app.xtrahelpcaregiver.Request.LangToken
import com.app.xtrahelpcaregiver.Request.LangTokenRequest
import com.app.xtrahelpcaregiver.Request.RemoveCardRequest
import com.app.xtrahelpcaregiver.Request.SaveCardRequest
import com.app.xtrahelpcaregiver.Response.CommonResponse
import com.app.xtrahelpcaregiver.Response.GetCardListResponse
...
class PaymentBillingActivity : BaseActivity(), CardTypeDetect, CardDeleteClickListner {
    ...
    private fun init() {
        ...
        cardAdapter = CardAdapter(activity,cardList)
